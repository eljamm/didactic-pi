window.onload = function () {
    ...
    document.querySelector('#seg-data-message-input').onkeyup = function (e) {
        if (e.keyCode === 13) {  // enter, return
            document.querySelector('#seg-data-message-submit').click();
        }
    };

    document.querySelector('#seg-data-message-submit').onclick = function (e) {
        const messageInputDom = document.querySelector('#seg-data-message-input');
    ...
    document.querySelector('#seg-clear-textarea').onclick = function (e) {
        const dataLogDom = document.querySelector('#seg-data-message-input');
        dataLogDom.value = '';
    };
